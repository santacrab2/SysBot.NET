...
namespace SysBot.Pokemon
{
    ...
    public class PokeDataOffsetsSV
    {
        ...
        public IReadOnlyList<long> PortalBoxStatusPointer { get; } = new long[] { 0x463AB60,0x188,0x350,0xF0,0x140,0x78 };  // 9-A in portal, 4-6 in box.
        public IReadOnlyList<long> IsConnectedPointer { get; } = new long[] { 0x461A3D8, 0x30 };
        public IReadOnlyList<long> OverworldPointer { get; } = new long[] { 0x46445D8,0x2A8,0x0,0x0,0x70};
